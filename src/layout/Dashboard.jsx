...
<li> <NavLink to="/dashboard/adminHome" className={({ isActive, isPending }) => isPending ? "pending" : isActive ? "active text-xl flex bg-blue-600 text-white p-4" : "p-4 text-lg flex"}>  <FaHome className='flex justify-center items-center mt-1 mx-2'></FaHome> Admin Home</NavLink></li> 
